  ...
  useEffect(() => {
    props.filterNotes(
      props.notes.filter(e =>
        e.title.toLowerCase().includes(props.searchInput.toLowerCase())
      )
    );
  }, [props.trigger]);
  ...
  return (
    <Modal isOpen={props.isOpen} toggle={props.toggleModal}>
      <ModalHeader toggle={props.toggleModal}>
        {props.modalView === "default" ? (
          <>
            <span>Notes</span>
            <button
              onClick={() => props.setModalView("add")}
              className="fancy-boi"
              id="solid-add"
            >
              Add Note
        ...
        {props.modalView === "add" ? (
          <>
            <span>Add Note</span>
            <button
              onClick={() => props.setModalView("default")}
              className="fancy-boi"
            >
              View Notes
            </button>
      ...
      <ModalBody>
        ...
        {props.modalView === "add" ? (
          <AddNote userID={props.userID} setModalView={props.setModalView} />
        ) : null}

        {props.modalView === "edit" ? (
          <EditNote note={noteToEdit} setModalView={props.setModalView} />
        ) : null}
      </ModalBody>
